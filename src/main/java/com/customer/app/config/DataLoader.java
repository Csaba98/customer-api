...
public class DataLoader {
	...
	public void runAfterStartup()  {
		String[] firstNames = {"Csaba", "Gábor", "Eszter", "Péter", "Dénes", "Géza", "Barbara", "József", "András", "Bence", "Márton", "Marcell", "Jácint", "Jázmin", "Dávid", "Iván", "Ábel", "Ferenc", "Sándor", "Balázs"};
		String[] lastNames = {"Horváth", "Kiss", "Bodnár", "Gémes", "Jakab", "Tóth", "Sipos", "Faragó", "Sárközi", "Vörös", "Szűcs", "Nagy", "Csontos", "Orosz", "Vasteleki"};
		...
		for(int i = 1; i <= 200; i++) {
			...
			customer.setPhone(String.format("%s%s", CommonUtil.getRandomElement(phonePrefixes), rand.nextInt(1000000, 9999999)));
			customer.setUsername((String.format("%s.%s", customer.getFirstname().toLowerCase(), customer.getLastname().toLowerCase())));
