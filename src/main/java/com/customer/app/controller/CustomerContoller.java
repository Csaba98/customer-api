...
public class CustomerContoller {
	...
	public ResponseEntity<List<Customer>> getCustomersAgeRange(HttpServletRequest request, 
															   @RequestParam("minAge") String reqMinAge, 
															   @RequestParam("maxAge") String reqMaxAge) {
		Byte minAge, maxAge;
	...
	@DeleteMapping("/{id}") 
	public ResponseEntity<String> deleteCustomerById(HttpServletRequest request, 
													 @PathVariable("id") String reqId) {
		Long id;
		CommonUtil.writeToLOG(HttpMethod.DELETE, request.getRequestURI());
